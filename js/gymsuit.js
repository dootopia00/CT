...
function solution(n, lost, reserve) {
    ...
    // 교집합
    set = lost.filter(it => reserve.includes(it));
    console.log('set : ', set);

    // 여분을 가지고 왔는데 도둑맞은 케이스 배열에서 제거
    ...
    lost.sort(function compare(a, b) {return a - b;});
    reserve.sort(function compare(a, b) {return a - b;});

    console.log('lost22 : ', lost);
    console.log('reserve22 : ', reserve);
